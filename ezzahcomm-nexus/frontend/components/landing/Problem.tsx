  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center mb-16">
        <p className="text-xs font-semibold tracking-widest text-blue-600/70 uppercase mb-4">The Problem</p>
        <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">
          Running a business in Africa<br />
          <span className="text-slate-400">is relentlessly manual.</span>
        </h2>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {PAINS.map(({ icon, title, body }) => (
          <div key={title} className="border border-slate-200 rounded-2xl p-8 bg-white shadow-sm hover:shadow-md hover:border-slate-300 transition-all">
